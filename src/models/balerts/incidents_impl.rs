...
impl Incidents {
    ...
    pub fn find_active(conn: &mut ConnType, target_id: &str) -> Result<Self, AppError> {
        Ok(dsl_incidents
...
impl IncidentsDTO {
    ...
    pub fn ginsert(&self, conn: &mut ConnType) -> Result<Incidents, AppError> {
...
impl IncidentsDTOUpdate {
    ...
    pub fn gupdate(&self, conn: &mut ConnType, target_id: i32) -> Result<Incidents, AppError> {
